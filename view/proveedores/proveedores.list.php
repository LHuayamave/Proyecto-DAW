        ...
        <table class=" ">
            ...
            <tbody class="tabladatos">
                ...
                <tr>
                    ...
                    <td>
                        <a class=" " 
                            href="index.php?c=productos&f=view_edit&id=<?php echo  $fila['id_proveedor']; ?>">
                            <i class="fa-light fa-pen-to-square"></i>
                        </a>
                        <a class=" " 
                            onclick="if(!confirm('Esta seguro de eliminar a este proveedor?'))return false;" 
                            href="index.php?c=productos&f=delete&id=<?php echo  $fila['id_proveedor']; ?>">
